...
from issues_list.views import get_issues_list, get_issue_detail, create_an_item, edit_an_item, cast_an_upvote
urlpatterns = [
    ...
    url(r'^(?P<id>\d+)$', get_issue_detail, name='issue_detail'),
